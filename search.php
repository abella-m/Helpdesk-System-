                            ...
                            ?>
                                <tr>
                                  ...
                                  ?> </td>
                                    ...
                                    <td> <a href="#" ><button class="btn-Open"  id="openbtn" onclick="show_Open('<?php echo $row['Id']?>','<?php echo $row['ID_Number']?>','<?php echo $row['Lastname']?>','<?php echo $row['Firstname']?>', '<?php echo $row['Middlename']?>', '<?php echo $row['Category']?>', '<?php echo $row['Request_Type']?>','<?php echo $row['Date']?>', '<?php echo $row['Time']?>', '<?php echo $row['Details']?>', '<?php echo $row['PriorityLevel']?>','<?php echo $row['Department_Office']?>')"><a href="#"><i class="far fa-eye fa-color-open"></i></a></button></a> 
