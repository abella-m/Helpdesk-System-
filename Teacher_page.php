...
<body>
    <div class="container">
        ...
        <nav class="navbar">
            <ul>
              <div class="items">
                <li><a href="Teacher_page.php"><!--<i class="fas fa-home fa-color-hm "></i>-->Home</a></li>
                ...
                <?php
                   ...
                   ?>
                <li><a href="Teacherchat.php" id="Message" class="button" class="Message_notification">Message <span class="badge"><?php if ($count2 > 0){echo"".$count2."";}?></span></a></li>
      ...
      <div class="modal-content-request">
        <div class="modal-header-request">
          ...
          <div class="request-container">
           ...
           <form class="request-form" action="Teacher_request.php" method="POST">
              ...
              <div class="return-query-container">
                <div class="return-query-content">
                  <div class="return-query" > 
                    <form action="Teacher_query_status_update.php" method="POST">
              ...
              <div class="return-remarks-container">
                <div class="return-remarks-content">
                  <div class="return-remarks" > 
                    <form action="teacher_remarks.php" method="POST">
