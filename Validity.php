...
if($validity == 0){
 echo "<script>alert('Has Been sucessfully Invalidated'); window.location = 'Admin_page.php';</script>";
   $query_status = "UPDATE tbl_request set query_status = 'Completed' where Id = '$id' ";
	...
	echo "<script>alert('Has been sucessfully Validated'); window.location = 'Admin_page.php';</script>";
}
?>